...
uint256 hashGenesisBlock("0x7b8caafdcd1403afb68c94efb16460d0dd6332aa0b064f40dce925215f03ac60");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3d736948cbc9fe913056844c04cd9a852c211a86a161b19849a6eb4a1643dab7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is Funcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04b8d6f153aae51f97d1b1bd2d597cc9cae20f9f6616520cbc69f75510fb53a0b1323099aa160fad5b99cec0a7543937343d6487c7c9591fceb82a2a58f71a8af8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1520230486;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086576288;

        if (fTestNet)
        {
            block.nTime    = 1520230438;
            block.nNonce   = 387814616;
        }
	...
	if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xe5c299f4bf9f3e16e99945bd3b729a6e150bf5fa87a8d9b3a24a8e51736a7fb6"));
        block.print();
